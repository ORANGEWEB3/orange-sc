...
/**
 * @dev Base Contract of NFT, which extend ERC721A
 * @dev All function stated here will become the global function which can be used by any version of NFT
 */
contract BaseNFT is
    ERC721A,
    Pausable,
    ...
    DefaultOperatorFilterer
{
    ...
    function safeTransferFrom(address from, address to, uint256 tokenId) public whenNotPaused override onlyAllowedOperator(from) {
...
contract NFTStandard is NFTSale, Initializable {
    /**
     * @dev Initialization of the standard NFT.
     ...
     */
    function initialize(ParamStructs.StandardParams calldata params) external initializer onlyOwner  {
